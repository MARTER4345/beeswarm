        ...
        ["embeds"] = {
            {
                ...
                "\n**Current Honey:** "..datahoneyWH.." ("..api.suffixstring(rtsg().Honey)..
                ")\n**Total gained:** "..totalhoneyWH.." ("..api.suffixstring(totalhoneyWH),
                ["type"] = "rich",
            ...
            ["embeds"] = {
                {
                    ...
                    "\nPosition: "..tostring(temptable.puffhook.CacheCFrame),
                    ["type"] = "rich",
                    ["color"] = tonumber(0x7269da),
                }
            }

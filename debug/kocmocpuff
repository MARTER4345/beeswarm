...
function sendwebhook()
    if _G.Webhook then
        local datahoneyWH = game.Players.LocalPlayer.PlayerGui.ScreenGui.MeterHUD.HoneyMeter.Bar.TextLabel.Text
        local totalhoneyWH = temptable.honeycurrent - temptable.honeystart
        local data = {
        ["content"] = "", 
        ["embeds"] = {
            {
                ...
                "\n**Current Honey:** "..datahoneyWH..
                "\n**Total gained:** "..totalhoneyWH.."("..api.suffixstring(temptable.honeycurrent - temptable.honeystart)..")",
                ["type"] = "rich",
...
function sendpuffhook()
    if _G.Puffwebhook then
        if temptable.puffhook.CacheCFrame ~= temptable.puffhook.CFrame then --send webhook
            ...
            temptable.puffhook.CFrameWH = tonumber(temptable.puffhook.CacheCFrame)
        local data = {
            ["content"] = "", 
            ["embeds"] = {
                {
                    ...
                    "\nPosition: "..temptable.puffhook.CFrameWH,
                    ["type"] = "rich",
                    ["color"] = tonumber(0x7269da),
                }
            }
